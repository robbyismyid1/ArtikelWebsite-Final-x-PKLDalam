...
@section('title')
    Bidang Studi
@endsection
@section('header') Bidang Studi @endsection
@section('button-add')
    <div class="section-header-button">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create-bs">Tambah Data</button>
    </div>
@endsection
@section('desc') Kumpulan data bidang studi @endsection
@section('header-2') Bidang Studi @endsection
              ...
              <tbody>
                @foreach($bidangstudi as $data)
                    <tr>
                        ...
                        <td>{{ $data->nama }}</td>
                        <td>
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#edit-bs" data-id="{{ $data->id }}" data-nama="{{ $data->nama }}">Edit</button>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-bs" data-id="{{ $data->id }}" data-nama="{{ $data->nama }}">Delete</button>
                        </td>
                    </tr>
                @endforeach
              </tbody>
